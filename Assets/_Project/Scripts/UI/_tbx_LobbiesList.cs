...
public class _tbx_LobbiesList : MonoBehaviour
{
    [SerializeField] private Transform lobbyItemParent;
    [SerializeField] private _tbx_LobbyItem lobbyItemPrefab;
    ...
    public async void JoinAsync(Lobby lobby)
    {
        ...
        try
        {
            ...
            await _tbx_ClientManager.Instance.StartClient(joinCode);
        }
        catch(LobbyServiceException e)
        {
